...
const MajorNews = ({ majorNews, BASE_URL, CalendarIcon, PlayIcon,formatDate }) => {
  return (
    <>
                {/* Major News Article */}
                {majorNews && (
              <div className="bg-white hidden md:block overflow-hidden transition-shadow cursor-pointer">
