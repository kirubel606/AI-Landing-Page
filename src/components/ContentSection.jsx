          ...
          <div className="max-w-6xl mx-auto">
            {large ? (
              ...
              <div className="flex flex-row md:flex-col gap-4 md:order-1 md:flex-1">
                <img
                  src={'http://127.0.0.1:8000/'+images[1] || "/placeholder.svg?height=150&width=200"}
                  alt="Event 1"
                  className="w-full h-32 md:h-[240px] object-cover rounded-lg shadow-md shadow-orange-300"
                />
                <img
                  src={'http://127.0.0.1:8000/'+images[2] || "/placeholder.svg?height=150&width=200"}
                  alt="Event 2"
              ...
              <div className="flex flex-row md:flex-col gap-4 md:order-3 md:flex-1">
                <img
                  src={'http://127.0.0.1:8000/'+images[3] || "/placeholder.svg?height=150&width=200"}
                  alt="Event 3"
                  className="w-full h-32 md:h-[240px] object-cover rounded-lg shadow-md shadow-orange-300"
                />
                <img
                  src={'http://127.0.0.1:8000/'+images[4] || "/placeholder.svg?height=150&width=200"}
                  alt="Event 4"
                  className="w-full h-32 md:h-[150px] object-cover rounded-lg shadow-md shadow-orange-300"
                />
              </div>
                ...
                <img src={'http://127.0.0.1:8000/' + images[0] || "/placeholder.svg"} alt="AI Conference" className="w-full h-96 object-cover rounded-lg shadow-lg shadow-orange-300" /> 
                <div className="grid grid-cols-2 md:grid-cols-4 w-full gap-4"> 
                  {[1, 2, 3, 4].map((i) => (
                    <img key={i} src={'http://127.0.0.1:8000/' + images[i] || `/placeholder.svg?height=150&width=200`} alt={`Event ${i}`} className="w-full h-32 object-cover rounded-lg shadow-md shadow-orange-300" />
                    ))} 
                    </div>
                </div>
            )}
